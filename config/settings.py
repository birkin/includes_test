...
SECRET_KEY = os.environ['INC_TEST__SECRET_KEY']

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = json.loads( os.environ['INC_TEST__DEBUG_JSON'] )  # will be True or False

ADMINS = json.loads( os.environ['INC_TEST__ADMINS_JSON'] )

ALLOWED_HOSTS = json.loads( os.environ['INC_TEST__ALLOWED_HOSTS'] )  # list
...
template_dirs = json.loads( os.environ['INC_TEST__TEMPLATES_JSON'] )
TEMPLATES = [
    {
...
# DATABASES = json.loads( os.environ['INC_TEST__DATABASES_JSON'] )
...
# Email
EMAIL_HOST = os.environ['INC_TEST__EMAIL_HOST']
EMAIL_PORT = int( os.environ['INC_TEST__EMAIL_PORT'] )
...
LOGGING = {
    ...
    'handlers': {
        'logfile': {
            ...
            'filename': os.environ.get(u'INC_TEST__LOG_PATH'),
            'formatter': 'standard',
        },
        'console':{
            'level':'DEBUG',
